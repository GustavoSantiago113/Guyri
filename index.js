...
var controleCampo = 0;
            ...
            {
                controleCampo++;
                document.getElementById('formulario').insertAdjacentHTML('beforeend', '<div class="form-group" id="campo'+ controleCampo +'"><label>Vazão do equipamento (l/s): </label><input type="text" id="vazao'+ controleCampo +'"<label>Tempo de uso (min): </label><input type="text" id="tempo'+ controleCampo +'" ><label>Frequência diária de uso: </label><input type="text" id="frequencia'+ controleCampo +'"><br><button type="button" onclick="Adicionar()">+</button><button type="button" onclick="Remover('+ controleCampo +')">-</button></div><br>');
            }
